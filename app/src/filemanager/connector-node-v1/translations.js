const translations = {
  en: {
    ...
    it: {
        ...
        rename: 'Rinomina',
        creating: 'Creando',
        creatingName: 'Creando {name}...',
        create: 'Crea',
        createFolder: 'Crea cartella',
        zipping: 'Comprimendo',
        zippingItem: 'Comprimendo 1 elemento',
        zippingItems: 'Comprimendo {quantity} elementi',
        items: 'elementi',
        item: 'elemento',
        cancel: 'Cancella',
        confirm: 'Conferma',
        ...
        files: 'files',
        fileExist: 'Il file o la cartella con nome {name} è già presente',
        newName: 'Nuovo nome',
        emptyName: 'Il nome non può essere vuoto',
        tooLongFolderName: 'Il nome della cartella non può contenere più di 255 caratteri',
        folderNameNotAllowedCharacters: 'Il nome della cartella contiene caratteri non consentiti',
        title: 'Titolo',
        fileSize: 'Dimensione file',
        lastModified: 'Ultima modifica',
        reallyRemove: '{files} verrà cancellato. Sei sicuro di voler proseguire?',
        unableReadDir: 'Impossibile visualizzare il percorso della cartella'
    },
