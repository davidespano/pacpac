...
const ActionTypes = {
    ...
    LOAD_DEBUG_SAVES: 'LOAD_DEBUG_SAVES',
    ...
    SET_DEBUG_RUN_STATE: 'SET_DEBUG_RUN_STATE',
    SET_HOME_SCENE: 'SET_HOME_SCENE',
    SET_GAME_TITLE: 'SET_GAME_TITLE',
    UPDATE_AUDIO_FILTER: 'UPDATE_AUDIO_FILTER',
    UPDATE_DEBUG_SAVE_NAME_FILTER: 'UPDATE_DEBUG_SAVE_NAME_FILTER',
    UPDATE_DEBUG_RUN_STATE: 'UPDATE_DEBUG_RUN_STATE',
    ...
    UPDATE_OTHER_SCENES_OBJECTS_NAME_FILTER: 'UPDATE_OTHER_SCENES_OBJECTS_NAME_FILTER',
