...
class Curved extends Component
{
    ...
    render(){
        ...
        let playMaterial = "opacity:0;visible:false;side:double";
        let material = "opacity:0.5;visible:true;side:double";
        return(
            <Entity material={playMaterial} geometry={"primitive: polyline; vertices: " +
